				...
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
							...
							<small>名字：${name }</small>
							&nbsp;&nbsp;&nbsp;
							<small>学院：${department }</small>
							&nbsp;&nbsp;&nbsp;
							<small>专业：${major }</small>
							&nbsp;&nbsp;&nbsp;
							<small>班级：${classNum }</small>
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
...
<!-- 第一个model 开始 -->
<div id="pswModal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keybord="false">
	<div class="modal-dialog" style="width:700px">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="pswForm" class="form-horizontal">
			...
			$(function () {
				...
				if(parseInt("${id}")==1){ //管理员
					data=[{
					    ...
					    text: '课题选择',
					    icon: 'fa fa-gg',
					    url: 'selectTopic.action'
					    },{
					    id: '03',
					    text: '已选课题信息',
					    icon: 'fa fa-gg',
					    url: 'selectedTopic.action'
					    },{
					    id: '04',
					    text: '提交文档',
					    icon: 'fa fa-gg',
					    url: 'commitFile.action'},
					    ]	
