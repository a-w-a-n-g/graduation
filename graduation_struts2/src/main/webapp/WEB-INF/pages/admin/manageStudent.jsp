		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="setForm" class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-4 control-label"  for="id">学生学号</label>
						<div class="col-sm-6">
							    <input class="form-control" type="text"  name="student.id" underline="true"  placeholder="请输入学号"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label" for="department">所在学院</label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="major">所属专业</label>
						<div class="col-sm-6">
							    <input class="form-control" type="text"  name="major" underline="true"  placeholder="请输入专业"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label" for="classNum">所在班级</label>
						<div class="col-sm-6">
							    <input class="form-control" type="text"  name="classNum" underline="true"  placeholder="请输入班级"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							   <input class="form-control" type="text"  name="student.name" underline="true" placeholder="请输入性别"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							   <input class="form-control" type="text"  name="sex" underline="true" placeholder="请输入性别"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-6">
							   <input class="form-control" type="text"  name="student.phone" underline="true"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label" for="mail">邮箱</label>
						<div class="col-sm-6">
							   <input class="form-control" type="text"  name="student.mail" underline="true"/>
							<!-- <input class="form-control" type="text" name = "roomName" placeholder="请输入教室名称"> -->
						</div>
					</div>
...
var operation={
	...
	addForm:function(){
		...
		if($("#setForm").data("bootstrapValidator").isValid()){
			var temp = getFormJson("setForm");
			 ...
			 $.ajax
	         ({
	                 url: 'insertStu.action', //用于文件上传的服务器端请求地址
	...
	editWindow:function(){
		...
		if(rows.length == 1  ){
			...
			document.getElementsByName('student.id')[0].value=rows[0].id;
			if(rows[0].name != undefined)
			document.getElementsByName('student.name')[0].value=rows[0].name;
			if(rows[0].phone != undefined)
			document.getElementsByName('student.phone')[0].value=rows[0].phone;
			if(rows[0].mail != undefined)
			document.getElementsByName('student.mail')[0].value=rows[0].mail;
			$('#setModal').modal('show');
		...
		if(rows.length == 1  ){
			bootbox.confirm({
				...
				callback:function(result){
					if(result){
						$.post("deleteStu.action", {'student.id':rows[0].id} ,function(data) {
							$("#dg").bootstrapTable("refresh");
							message.alert(data.showInfo);
...
var columns=[[
	...
	},  
	{
		...
		visible:false
	     ...
	     {title: '学生学号', field: 'id', align: 'center', valign: 'middle',visible:true},
	     {title: '所在学院', field: 'department', align: 'center', valign: 'middle',visible:true},
	     {title: '所属专业', field: 'major', align: 'center', valign: 'middle',visible:true},
	     {title: '所在班级', field: 'classNum', align: 'center', valign: 'middle',visible:true},
	     {title: '学生姓名', field: 'name', align: 'center', valign: 'middle',visible:true},
	     {title: '性别', field: 'sex', align: 'center', valign: 'middle',visible:true},
	     {title: '联系电话', field: 'phone', align: 'center', valign: 'middle',visible:true},
	     {title: '邮箱', field: 'mail', align: 'center', valign: 'middle',visible:true},
