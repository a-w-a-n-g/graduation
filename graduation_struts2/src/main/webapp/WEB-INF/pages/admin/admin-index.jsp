			...
			$(function () {
				...
				if(parseInt("${id}")==3){ //管理员
					data=[{
					    ...
					    text: '学院管理',
					    icon: 'fa fa-gg',
					    url: 'manageDep.action'
					    },{
					    id: '03',
					    text: '专业管理',
					    icon: 'fa fa-gg',
					    url: 'manageMajor.action'
					    },{
					    id: '04',
					    text: '班级管理',
					    icon: 'fa fa-gg',
					    url: 'manageClass.action'
					    },{
					    id: '05',
					    text: '教师管理',
					    icon: 'fa fa-gg',
					    url: 'manageTeacher.action'
					    },{
					    id: '06',
					    text: '学生管理',
					    icon: 'fa fa-gg',
					    url: 'manageStu.action'
					    },{
					    id: '07',
					    text: '审核处理',
					    icon: 'fa fa-gg',
					    url: 'adminCheck.action'},
					    ]	
